...
public class SearchBox extends JTextField implements CaretListener, FocusListener {
    ...
    private java.util.List<Object> searchResultList;
    ...
    public SearchBox(java.util.List<?> objectList, Dimension resultBoxSize) {
        this.objectList =  (java.util.List<Object>) objectList;
    ...
    public void setSearchResultList(java.util.List<Object> searchResultList) {
