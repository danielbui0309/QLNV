...
public class WorkerPaymentPanel extends JPanel implements Observer, FocusListener, ActionListener {
    ...
    private String[] paymentTableColumns = {"ID", "Job", "Payment Method", "Amount"}; //delete date
    ...
    public WorkerPaymentPanel() {
        ...
        workerSearchBox = new SearchBox(WorkerDAO.getInstance().list(), new Dimension((RLW - 30) / 2, LH)) {
            ...
            public void mouseAction(MouseEvent e, Object searchResultObject, int chooseIndex) {
                ...
                workerTextField.setText(selectedWorker.toString());
                workerSearchBox.setEditable(false);
                jobSearchBox.requestFocus();
                refreshData();
                super.mouseAction(e, searchResultObject, chooseIndex);
            }
        };
        workerSearchBox.setBounds(RLX, RLY + 64 + 10, (RLW - 30) / 2, LH);
        workerSearchBox.addFocusListener(new FocusListener() {
            @Override
        ...
        jobSearchBox = new SearchBox(JobDAO.getInstance().list(), new Dimension((RLW - 30) / 2, LH)) {
            ...
            public void mouseAction(MouseEvent e, Object searchResultObject, int chooseIndex) {
                ...
                jobTextField.setText(selectedJob.toString());
    ...
    private boolean decimalControl(String ...args) {
        Pattern pattern = Pattern.compile("^\\d+(\\.\\d{1,3})?$"); // decimal pattern xxx.xx
        boolean result = true;
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == payButton) {
            ...
            if(!decimalControl(amount) || worker == null || job == null || paytype == null) {
                String message;
                message = "Please enter selection parts or format correctly (max 3 floating point)";
    ...
    private void clearPanel() {
        ...
        if(selectedWorker != null) {
            ...
            String[][] tableData = new String[paymentList.size()][4];
