...
public class JobDisplay extends JPanel implements Observer {
    ...
    private final String[] jobWorkTableColumns = {"ID", "Job title", "Work type", "Count", "Description"}; //Delete date
    ...
    public JobDisplay(){
        ...
        jobSearchBoxImageLabel = new JLabel(new ImageIcon("src\\icon\\search.png"));
        jobSearchBoxImageLabel.setBounds(RLX + (RLW - 64) / 2, RLY - 5, 60, 60);
        ...
        jobSearchBox.addFocusListener(new FocusListener() {
            @Override
