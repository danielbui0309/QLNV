...
import com.cbozan.DAO.*;
import com.cbozan.Entity.*;
...
public class WorkerDisplay extends JPanel implements Observer {
    ...
    private final String[] workTableColumns = {"ID", "Job", "Worker", "Work type", "Description"}; //Delete date
    private final String[] workerPaymentTableColumns = {"ID", "Job", "Worker", "Pay type", "Amount"}; //Delete date
...
//                workTableWorktypeFilterSearchBox.setText(selectedWorktype.toString().toLowerCase());
...
//        this.add(removeWorkTableDateFilterButton);
        ...
        removeWorkerPaymentJobFilterButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                System.out.println("This is work type");
                removeWorkerPaymentJobFilterButton.setVisible(false);
...
//        this.add(removeWorkerPaymentDateFilterButton);
    ...
    public void updateWorkerPaymentTableData() {
        ...
        if(selectedWorker != null) {
            ...
            java.util.List<Payment> paymentList;
    ...
    public void filterPaymentJob(java.util.List<Payment> paymentList) {
    ...
    public void filterJob(java.util.List<Work> workList) {
